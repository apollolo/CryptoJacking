    ...
    (this._tab.mode = e || Minero.IF_EXCLUSIVE_TAB),
      ...
      this._useWASM || "loaded" === this._asmjsStatus
        ...
        : "unloaded" === this._asmjsStatus &&
          ...
          t.open("get", Minero.CONFIG.LIB_URL + "cryptonight-asmjs.min.js", !0),
          t.send());
  }),
